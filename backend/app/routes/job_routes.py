...
def create_job():
    ...
    required = ["title", "description", "budget_min", "budget_max",
                "budget_type", "deadline", "category", "experience_level", "client_id"]
...
def update_job(job_id):
    ...
    allowed = ["title", "description", "budget_min", "budget_max",
               "budget_type", "deadline", "category",
               "experience_level", "skills", "status"]
